...
export type CreateSubscribeProps<TChildProps = {}, TDataName extends string = 'mutate'> = {
      [key in TDataName]: Apollo.MutationFunction<CreateSubscribeMutation, CreateSubscribeMutationVariables>
    } & TChildProps;
export function withCreateSubscribe<TProps, TChildProps = {}, TDataName extends string = 'mutate'>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  CreateSubscribeMutation,
  CreateSubscribeMutationVariables,
  CreateSubscribeProps<TChildProps, TDataName>>) {
    return ApolloReactHoc.withMutation<TProps, CreateSubscribeMutation, CreateSubscribeMutationVariables, CreateSubscribeProps<TChildProps, TDataName>>(CreateSubscribeDocument, {
      alias: 'createSubscribe',
      ...operationOptions
    });
};
